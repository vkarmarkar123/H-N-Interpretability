...
df = pd.read_csv("E:\OneDrive - University of California, Davis\HN Model Development\Data\HN_P2C_20231207.csv")
cwd = os.getcwd()
...
# Here you can filter the data based on case numbrer